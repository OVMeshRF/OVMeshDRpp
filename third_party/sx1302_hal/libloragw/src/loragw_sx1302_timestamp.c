...
int timestamp_counter_get(timestamp_counter_t * self, uint32_t * inst, uint32_t * pps) {
    ...
    */
    ...
    counter_pps_us_raw_27bits_now  = ((uint32_t)buff[0]<<24) | ((uint32_t)buff[1]<<16) | ((uint32_t)buff[2]<<8) | (uint32_t)buff[3];
    counter_inst_us_raw_27bits_now = ((uint32_t)buff[4]<<24) | ((uint32_t)buff[5]<<16) | ((uint32_t)buff[6]<<8) | (uint32_t)buff[7];
...
uint32_t timestamp_counter_expand(timestamp_counter_t * self, bool pps, uint32_t cnt_us) {
    ...
    counter_us_32bits = ((uint32_t)tinfo->counter_us_27bits_wrap << 27) | cnt_us;
...
uint32_t timestamp_pkt_expand(timestamp_counter_t * self, uint32_t pkt_cnt_us) {
    ...
    */
    ...
    counter_us_32bits = ((uint32_t)wrap_status << 27) | pkt_cnt_us;
...
int precise_timestamp_calculate(uint8_t ts_metrics_nb, const int8_t * ts_metrics, uint32_t timestamp_cnt, uint8_t sf, int32_t if_freq_hz, double pkt_freq_error, uint32_t * result_ftime) {
    ...
    timestamp_pps_reg  = ((uint32_t)buff[0] << 24) & 0xFF000000U;
    timestamp_pps_reg |= ((uint32_t)buff[1] << 16) & 0x00FF0000U;
    timestamp_pps_reg |= ((uint32_t)buff[2] << 8)  & 0x0000FF00U;
    timestamp_pps_reg |= ((uint32_t)buff[3] << 0)  & 0x000000FFU;
