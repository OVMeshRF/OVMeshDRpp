...
Support reports should include application/OS/driver versions, device model, sanitized configuration, symptom timing, sample-loss and decoder-health counters, and reproduction steps. Preview reports and screenshots locally before sharing. Exclude keys, packet bytes, message content, precise GPS routes, and raw RF captures.
